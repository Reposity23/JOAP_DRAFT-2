      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="h-7 text-xs rounded-md border bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-100 px-2"
            data-testid="select-map-period"
          >
            <option value="daily" className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-100">Daily</option>
            <option value="weekly" className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-100">Weekly</option>
            <option value="monthly" className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-100">Monthly</option>
            <option value="yearly" className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-100">Yearly</option>
          </select>
        </div>
      </CardHeader>
      <CardContent>
