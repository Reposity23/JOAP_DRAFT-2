...
const ADMIN_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    mp3File: "tut5.mp3",
    actions: [
      { triggerTime: 0.5, type: "scroll", target: "[data-testid='card-customer-map']" },
      { triggerTime: 1, type: "move", target: "[data-testid='card-customer-map']" },
      { triggerTime: 3, type: "clickFirst", target: "[data-testid^='marker-city-']" },
      { triggerTime: 5, type: "highlight", target: "[data-testid='panel-city-detail']", highlightType: "small-circle" },
      { triggerTime: 7, type: "move", target: "[data-testid='card-customer-map']" },
    ],
  },
  {
    path: "/inventory",
